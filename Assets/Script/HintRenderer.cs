...
{
    public MazeCreating MazeCreating;
    ...
    public void DrawPath()
    {
        ...
        {
            positions.Add(new Vector3(x * MazeCreating.CellSize.x, y * MazeCreating.CellSize.y, y * MazeCreating.CellSize.z));
